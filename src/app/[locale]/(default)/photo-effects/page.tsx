    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          {/* Free Nano Banana Pro 功能卡片 */}
          <Link href="/photo-effects/free-nano-banana-pro" className="block">
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 cursor-pointer transform hover:scale-105 border border-yellow-200">
              ...
              <div className="flex items-center gap-2 mb-2">
                <h3 className="text-xl font-semibold text-gray-900">Free Nano Banana Pro</h3>
                <span className="bg-gradient-to-r from-yellow-600 to-red-600 text-white text-xs px-2 py-1 rounded-full font-medium">
                  PRO
                </span>
              </div>
              <p className="text-gray-600">
                The Ultimate Multi-Image Fusion AI Upgrade. Blend up to 4 images and prompts into stunning visual art with advanced control.
              </p>
              <div className="mt-4 flex items-center justify-between">
                <span className="bg-green-100 text-green-600 px-2 py-1 rounded-full text-xs font-medium">Available Now</span>
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
