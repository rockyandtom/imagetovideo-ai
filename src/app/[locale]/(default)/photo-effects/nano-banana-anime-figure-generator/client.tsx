          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Create stunning anime figures with our AI-powered Nano Banana generator. Powered by advanced <strong>Google Gemini image generation</strong> technology, transform your images into unique, high-quality anime figures instantly.
              </p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-bold text-foreground">The Technology Behind Nano Banana: Powered by Google Gemini Image Generation</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground leading-relaxed">
                      Unlike general-purpose AI tools, <strong>Nano Banana</strong> is specifically trained on anime art and character design. Powered by <strong>Google Gemini image generation</strong>, our specialized focus ensures that the figures it generates are stylistically accurate, detailed, and authentic to the anime genre.
                    </p>
                  </div>
                  <div className="space-y-2">
